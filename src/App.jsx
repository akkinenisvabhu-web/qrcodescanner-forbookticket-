...
// Import 'doc', 'getDoc', AND 'connectFirestoreEmulator'
import { getFirestore, doc, getDoc, setLogLevel, connectFirestoreEmulator } from 'firebase/firestore';
...
// --- !! THIS IS THE FIX !! ---
// We are using connectFirestoreEmulator as a workaround to set the database region.
// This is necessary since your database is in 'asia-south1'.
connectFirestoreEmulator(db, 'asia-south1', 8080);
// --- --- --- --- --- --- ---
...
    // If it's something like 'users/{userId}/tickets', this path needs to change.
    // Based on your request, we assume it's a top-level collection.
